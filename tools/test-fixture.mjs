...
export async function createFixture() {
  ...
  const names = (await fs.readdir(originalTool)).filter((file) => file.endsWith('.go') || ['go.mod', 'go.sum', 'corrections.json', 'id-registry.json', 'pipeline.mjs', 'review-state.mjs', 'console-model.mjs', 'console.mjs', 'knowledge-model.mjs', 'knowledge-mdx.mjs', 'rehype-knowledge.mjs'].includes(file));
